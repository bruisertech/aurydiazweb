...
const modalData = {
  ...
  macro2: {
    ...
    items_es: ['<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M3 3h18v18H3zM5 5v14h14V5H5zm2 2h2v2H7V7zm4 0h2v2h-2V7zm4 0h2v2h-2V7zM7 11h2v2H7v-2zm4 0h2v2h-2v-2zm4 0h2v2h-2v-2zM7 15h2v2H7v-2zm4 0h2v2h-2v-2zm4 0h2v2h-2v-2z"/></svg> Constitución de SAS, S.A., Ltda. — Ley 1258/2008','Código de Comercio — Decreto 410/1971','Fusiones, escisiones y adquisiciones','Insolvencia empresarial — Ley 1116/2006','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.31-8.86c-1.77-.45-2.34-.94-2.34-1.67 0-.84.79-1.43 2.1-1.43 1.38 0 1.9.66 1.94 1.64h1.71c-.05-1.34-.87-2.57-2.49-2.97V5H10.9v1.69c-1.51.32-2.72 1.3-2.72 2.81 0 1.79 1.49 2.69 3.66 3.21 1.95.46 2.34 1.15 2.34 1.87 0 .53-.39 1.64-2.1 1.64-1.71 0-2.28-.92-2.36-1.79H8.01c.08 1.61 1.15 2.89 2.89 3.32V19h2.4v-1.66c1.65-.37 2.8-1.38 2.8-2.98 0-2.09-1.67-2.88-3.79-3.36z"/></svg> Estatuto Tributario — Decreto 624/1989','Reforma tributaria — Ley 2277/2022','Defensa ante DIAN: sanciones y recursos','Régimen simple y facturación electrónica','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-1.3l-.85-.6C7.8 13.27 7 11.23 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.23-.8 4.27-2.15 5.1z"/></svg> Registro de marcas y patentes — Decisión 486 CAN','Derechos de autor — Ley 23/1982','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg> Propiedad Horizontal — Ley 675/2001','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg> Habeas Data Financiero — Ley 1581/2012 · Ley 1266/2008'],
    items_en: ['<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M3 3h18v18H3zM5 5v14h14V5H5zm2 2h2v2H7V7zm4 0h2v2h-2V7zm4 0h2v2h-2V7zM7 11h2v2H7v-2zm4 0h2v2h-2v-2zm4 0h2v2h-2v-2zM7 15h2v2H7v-2zm4 0h2v2h-2v-2zm4 0h2v2h-2v-2z"/></svg> Formation of SAS, S.A., Ltd. — Law 1258/2008','Commercial Code — Decree 410/1971','Mergers, spin-offs and acquisitions','Business insolvency — Law 1116/2006','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.31-8.86c-1.77-.45-2.34-.94-2.34-1.67 0-.84.79-1.43 2.1-1.43 1.38 0 1.9.66 1.94 1.64h1.71c-.05-1.34-.87-2.57-2.49-2.97V5H10.9v1.69c-1.51.32-2.72 1.3-2.72 2.81 0 1.79 1.49 2.69 3.66 3.21 1.95.46 2.34 1.15 2.34 1.87 0 .53-.39 1.64-2.1 1.64-1.71 0-2.28-.92-2.36-1.79H8.01c.08 1.61 1.15 2.89 2.89 3.32V19h2.4v-1.66c1.65-.37 2.8-1.38 2.8-2.98 0-2.09-1.67-2.88-3.79-3.36z"/></svg> Tax Statute — Decree 624/1989','Tax reform — Law 2277/2022','Defense before DIAN: sanctions and appeals','Simple regime and electronic invoicing','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-1.3l-.85-.6C7.8 13.27 7 11.23 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.23-.8 4.27-2.15 5.1z"/></svg> Trademark and patent registration — CAN Decision 486','Copyright — Law 23/1982','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg> Horizontal Property — Law 675/2001','<svg class="emoji-svg" viewBox="0 0 24 24" fill="var(--gold)" width="1em" height="1em"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg> Financial Habeas Data — Law 1581/2012 · Law 1266/2008'],
